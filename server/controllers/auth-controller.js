...
// Controllers are typically used to process incoming requests, interact with models(data sources), and send reponses back to clients.
// They help organize your application by separating concern the following the MVC(Model View Controller) design pattern
...
const home = async(req, res) => {
    try {
        ...
        .status(200)
        .send(
          "Welcome to world best MERN Series by Sanskar Singh Using Router"
         ); 
    } catch (error) {
        console.log(error);
    };
